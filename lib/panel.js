...
module.exports = class Panel {
   ...
   api_key = 'U9MD2Iz3u8QZswCtVNTKqnykeFXGRS'
   secret_key = 'jCpmUDd231S9WBiF7hVxozIYMlOLwEftyNqcbJPerRAs5kQnZX'
   ...
   layanan(page = 10) {
      return new Promise(async resolve => {
         try {
            ...
            require('fs').writeFileSync('./s.json', JSON.stringify(json, null, 3))
         } catch (e) {
            console.log(e)
            resolve({
               status: false
