exports.run = {
   ...
   async: async (m, {
      ...
      if (global.db.users[m.sender].point < 10000) return client.reply(m.chat, Func.texted('bold', `🚩 Point yang kamu miliki tidak cukup untuk bermain game suit, minimal mempunyai 10K point.`), m)
